...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $facturaProducto->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $facturaProducto->id)]
            )
        ?></li>
...
<div class="facturaProductos form large-9 medium-8 columns content">
    <?= $this->Form->create($facturaProducto) ?>
    <fieldset>
        <legend><?= __('Edit Factura Producto') ?></legend>
        <?php
