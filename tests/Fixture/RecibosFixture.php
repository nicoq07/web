...
class RecibosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_recibo_fact_idx' => ['type' => 'index', 'columns' => ['factura_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_recibo_fact' => ['type' => 'foreign', 'columns' => ['factura_id'], 'references' => ['facturas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
