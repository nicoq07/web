...
class RemitosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_remito_factura_idx' => ['type' => 'index', 'columns' => ['factura_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_remito_factura' => ['type' => 'foreign', 'columns' => ['factura_id'], 'references' => ['facturas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
