...
/**
 * FotosProductosFixture
 *
 */
class FotosProductosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'fk_fotos_prod' => ['type' => 'foreign', 'columns' => ['producto_id'], 'references' => ['productos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
