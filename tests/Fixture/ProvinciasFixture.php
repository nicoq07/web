...
class ProvinciasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_prov_pais_idx' => ['type' => 'index', 'columns' => ['pais_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_prov_pais' => ['type' => 'foreign', 'columns' => ['pais_id'], 'references' => ['paises', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
